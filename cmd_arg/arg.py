...
async def parse_cmd():
    ...
    parser.add_argument('--type', type=str, help='crawler type (search | detail | creator-plus | creator-only)',
                        choices=["search", "detail", "creator-plus", "creator-only"], default=config.CRAWLER_TYPE)
